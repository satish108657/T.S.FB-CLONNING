...
os.system("xdg-open https://chat.whatsapp.com/GrHZ8abRysBHGOFQePfY5U")
#app  check 
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/HON3Y-KING/aaprove.txt').text
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/9509343045')
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def xerx():
    ...
    print("\n\033[1;31m『1』 \033[1;32mNEPAL RANDOM CLONING\n\033[1;31m『2』 \033[1;32mINDIA RANDOM CLONING\n\033[1;31m『3』 \033[1;32mPAKISTAN RANDOM CLONING\n\033[1;31m『4』 \033[1;32mBANGLADESH RANDOM CLONING\n\033[1;31m『5』 \033[1;32mRANDOM CLONING WITH CHOOSE PASSWORD\n\033[1;31m『6』 \033[1;32mRANDOM CLONING FREE FIRE \n\033[1;31m『7』 \033[1;32mCONTACT OWNER")
    print('\n\033[1;38;5;208m  ❦ ═════════════════ •⊰❂⊱• ═════════════════ ❦')
    aryan = input("\n\033[1;31m  ✓CHOOSE => ")
    if aryan =='1':xerx1()
    elif aryan =='2':xerx2()
    ...
    elif aryan =='7':os.system("xdg-open https://www.facebook.com/profile.php?id=100087513362848")
    else:
